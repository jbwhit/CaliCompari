...
do
    ...
    TEMP="$(echo "$file" | awk -F _ '{print $4"."$5"."$6}' | awk -F . '{print $1"."$2"."$3".ascii"}' )"
    # This works for hires: 
    # echo "$file" | awk -F _ '{print $1"."$2"."$3}' | awk -F / '{print $1"."$2}' | awk -F . '{print $3".k."$4".ascii"}'
    # The plan: cut up every /, _, (), 
